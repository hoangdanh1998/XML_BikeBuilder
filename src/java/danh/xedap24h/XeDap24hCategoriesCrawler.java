 ...
 * @author apple
 */
public class XeDap24hCategoriesCrawler extends BaseCrawler {

    public XeDap24hCategoriesCrawler(ServletContext context) {
        super(context);
    }
    ...
    public Map<String, String> getCategories(String url) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.contains("id=\"menu-item-4780\"")) {
                    document += line.trim();
            ...
            Logger.getLogger(XeDap24hCategoriesCrawler.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public Map<String, String> stAXparserForCategories(String document) {
        ...
        try {
            ...
            Logger.getLogger(XeDap24hCategoriesCrawler.class.getName()).log(Level.SEVERE, ex.getMessage(), ex);
